...
if (! function_exists('generateRandomHex')) {
    /**
     * Generate a random hexadecimal string prefixed with '0x'.
     *
     * @param int $length
     * @return string
     */
    function generateRandomHex($length = 40) {
        ...
        // Convert binary string to hexadecimal and prefix with '0x'
        return '0x' . bin2hex($bytes);
    }
    
    function generateNumericReferralCode($userId) {
        // Generate a random number between 1000 and 9999
        // Adjust the range as needed for the length of the code
        $randomNumber = random_int(1000, 9999);
    
        // Combine the user ID with the random number
