        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div class="d-flex flex-wrap justify-content-between align-items-center">
                        <ul class="login-registration-list d-flex flex-wrap justify-content-between align-items-center">
                            @guest
                                ...
                                <li class="login-registration-list__item"><a href="{{ route('user.login') }}" class="login-registration-list__link"> @lang('Register')</a></li>
                            @else
                ...
                <ul class="navbar-nav nav-menu ms-auto">
                    ...
                    {{-- <li class="nav-item">
                        <a class="nav-link {{ menuActive('blogs') }}" href="{{ route('blogs') }}">@lang('Blogs')</a>
                    </li> --}}
                    @auth
                        <li class="nav-item">
                            <a class="nav-link {{ menuActive('ticket.open') }}" href="{{ route('ticket.open') }}">@lang('Support')</a>
                        </li>
                    @else
                        <li class="nav-item">
