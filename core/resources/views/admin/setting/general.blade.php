                    ...
                    <form action="" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-6">
                                ...
                                <div class="form-group">
                                    <label>@lang('Stock Current Rate')</label>
                                    <div class="input-group">
                                        <input class="form-control bal-charge" type="text" name="stock_current_rate" required value="{{ $general->stock_current_rate }}">
                            ...
                            <div class="col-md-4 col-sm-6">
                                ...
                                <div class="form-group">
                                    <label>@lang('Deposit Address')</label>
                                    <div class="input-group">
                                        <input class="form-control bal-charge" type="text" name="deposit_address" required value="{{ $general->deposit_address }}">
